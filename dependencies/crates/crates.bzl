...
def raze_fetch_remote_crates():
    ...
    maybe(
        ...
        build_file = Label("//dependencies/crates/remote:BUILD.cfg-if-1.0.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//dependencies/crates/remote:BUILD.getrandom-0.2.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//dependencies/crates/remote:BUILD.libc-0.2.115.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//dependencies/crates/remote:BUILD.ppv-lite86-0.2.16.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//dependencies/crates/remote:BUILD.rand-0.8.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//dependencies/crates/remote:BUILD.rand_chacha-0.3.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//dependencies/crates/remote:BUILD.rand_core-0.6.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//dependencies/crates/remote:BUILD.rand_hc-0.3.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//dependencies/crates/remote:BUILD.wasi-0.10.2+wasi-snapshot-preview1.bazel"),
    )
